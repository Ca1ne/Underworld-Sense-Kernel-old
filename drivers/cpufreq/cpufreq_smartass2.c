 ...
 */
#define DEFAULT_AWAKE_IDEAL_FREQ CONFIG_SMARTASS2_DEFAULT_AWAKE_IDEAL_FREQ;
 ...
 * also when suspended).
 */
#define DEFAULT_SLEEP_IDEAL_FREQ CONFIG_SMARTASS2_DEFAULT_SLEEP_IDEAL_FREQ;
 ...
 */
#define DEFAULT_RAMP_UP_STEP CONFIG_SMARTASS2_DEFAULT_RAMP_UP_STEP;
 ...
 */
#define DEFAULT_RAMP_DOWN_STEP CONFIG_SMARTASS2_DEFAULT_RAMP_DOWN_STEP;
static unsigned int ramp_down_step;

/*
 * CPU freq will be increased if measured load > max_cpu_load;
 */
#define DEFAULT_MAX_CPU_LOAD CONFIG_SMARTASS2_DEFAULT_MAX_CPU_LOAD;
static unsigned long max_cpu_load;

/*
 * CPU freq will be decreased if measured load < min_cpu_load;
 */
#define DEFAULT_MIN_CPU_LOAD CONFIG_SMARTASS2_DEFAULT_MIN_CPU_LOAD;
 ...
 */
#define DEFAULT_UP_RATE_US CONFIG_SMARTASS2_DEFAULT_UP_RATE_US * 1000;
 ...
 */
#define DEFAULT_DOWN_RATE_US CONFIG_SMARTASS2_DEFAULT_DOWN_RATE_US * 1000;
 ...
 */
#define DEFAULT_SLEEP_WAKEUP_FREQ CONFIG_SMARTASS2_DEFAULT_SLEEP_WAKEUP_FREQ;
static unsigned int sleep_wakeup_freq;

/*
 * Sampling rate, I highly recommend to leave it at 2.
 */
#define DEFAULT_SAMPLE_RATE_JIFFIES CONFIG_SMARTASS2_DEFAULT_SAMPLE_RATE_JIFFIES;
