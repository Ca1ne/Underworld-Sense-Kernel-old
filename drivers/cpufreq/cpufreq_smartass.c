 ...
 */
#define UP_THRESHOLD_FREQ CONFIG_SMARTASS_UP_THRESHOLD_FREQ
 ...
 */
#define DEFAULT_RAMP_DOWN_STEP CONFIG_SMARTASS_DEFAULT_MAX_RAMP_DOWN
 ...
 */
#define RAPID_MIN_CPU_LOAD CONFIG_SMARTASS_RAPID_MIN_CPU_LOAD
